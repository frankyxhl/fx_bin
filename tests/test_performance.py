...
class TestPerformanceLimits(unittest.TestCase):
    ...
    def test_large_directory_performance(self):
        ...
        self.assertLess(size_elapsed, 2.0, 
                       f"Size calculation too slow: {size_elapsed:.2f}s")
        self.assertLess(count_elapsed, 2.0, 
                       f"File counting too slow: {count_elapsed:.2f}s")
        self.assertEqual(file_count, num_files, 
                        f"Expected {num_files} files, got {file_count}")
        ...
        print(f"Performance: {num_files} files processed in {max(size_elapsed, count_elapsed):.2f}s")
    ...
    def test_convert_size_performance(self):
        ...
        print(f"convert_size performance: {len(test_sizes) * 1000} conversions in {elapsed:.3f}s")
    ...
    def test_concurrent_performance(self):
        ...
        self.assertLess(avg_worker_time, 1.0, 
...
class TestMemoryUsage(unittest.TestCase):
    ...
    def test_large_file_replacement_memory(self):
        ...
        print(f"Large file memory usage: {memory_increase / 1024 / 1024:.1f}MB increase")
    ...
    def test_directory_scanning_memory(self):
        ...
        print(f"Directory scan memory: {memory_increase / 1024 / 1024:.1f}MB for {num_files} files")
