...
def main():
    ...
    functionality_tests = [
        ...
        ("python3 -m unittest tests.test_find_files -v", "Find Files Module Functionality"),
        ("python3 -m unittest tests.test_integration.TestCLIIntegration -v", "CLI Integration"),
    ]
    ...
    total_tests = len(security_tests) + len(safety_tests) + len(functionality_tests) + len(performance_tests)
    total_passed = security_passed + safety_passed + functionality_passed + performance_passed
    ...
    print(f"🏃 Performance Tests:   {performance_passed}/{len(performance_tests)} passed")
