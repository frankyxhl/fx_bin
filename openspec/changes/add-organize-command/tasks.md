...
- [ ] 14.1.1 Verify `--help` shows all options (hidden, recursive, clean-empty, fail-fast)
- [ ] 14.1.2 Verify option help text is correct

### 14.2 Manual Testing - Recursive Behavior
- [ ] 14.2.1 Create test directory with subdirectory and file
- [ ] 14.2.2 Verify default (non-recursive) doesn't process subdirectory
- [ ] 14.2.3 Verify `--recursive` processes subdirectory

### 14.3 Manual Testing - Confirmation
- [ ] 14.3.1 Verify confirmation prompt appears before execution
- [ ] 14.3.2 Verify `--yes` skips confirmation
- [ ] 14.3.3 Verify cancel works correctly

### 14.4 Manual Testing - Clean Empty
- [ ] 14.4.1 Create directories that become empty after moves
- [ ] 14.4.2 Verify `--clean-empty` removes empty directories
- [ ] 14.4.3 Verify directories outside source are NOT removed

### 14.5 Manual Testing - Verbose/Quiet
- [ ] 14.5.1 Verify `--verbose` shows source/target/status for each file
- [ ] 14.5.2 Verify `--quiet` only shows errors and summary
- [ ] 14.5.3 Verify default mode shows progress

### 14.6 Manual Testing - Fail Fast
- [ ] 14.6.1 Create condition that causes error (e.g., permission denied)
- [ ] 14.6.2 Verify `--fail-fast` stops on first error
- [ ] 14.6.3 Verify default mode continues on error

### 14.7 Automated Testing
- [ ] 14.7.1 Run all tests: `poetry run pytest tests/ -v`
- [ ] 14.7.2 Verify all tests pass

### 14.8 Code Quality Checks
- [ ] 14.8.1 Run flake8: `poetry run flake8 fx_bin/`
- [ ] 14.8.2 Run black: `poetry run black fx_bin/ tests/`
- [ ] 14.8.3 Run mypy: `poetry run mypy fx_bin/`
- [ ] 14.8.4 Run bandit: `poetry run bandit -r fx_bin/`

### 14.9 Coverage Check
- [ ] 14.9.1 Run coverage: `poetry run pytest --cov=fx_bin --cov-report=term-missing`
- [ ] 14.9.2 Verify coverage ≥ 80%

### 14.10 Archive
- [ ] 14.10.1 Run `openspec validate add-organize-command --strict`
- [ ] 14.10.2 Run `openspec archive add-organize-command --yes`
